...
Package.onUse(function(api) {
  ...
  api.addFiles('client/dataRoom/dataRoom.html', 'client');
  api.addFiles('client/dataRoom/dataRoom.js', 'client');
  api.addFiles('client/dataRoom/fileRow.html', 'client');
  api.addFiles('client/dataRoom/fileRow.js', 'client');
  api.addFiles('client/dataRoom/fileUpload.html', 'client');
  api.addFiles('client/dataRoom/fileUpload.js', 'client');
  api.addFiles('client/dataRoom/hubFile.html', 'client');
  api.addFiles('client/dataRoom/hubFile.js', 'client');
  ...
  api.addFiles('client/members/manageTeam.html', 'client');
  api.addFiles('client/members/manageTeam.js', 'client');
  api.addFiles('client/hubNav.html', 'client');
  api.addFiles('client/hubNav.js', 'client');
  api.addFiles('client/hubNav/hubListItemMenu.html', 'client');
  api.addFiles('client/hubNav/hubListItemMenu.js', 'client');
